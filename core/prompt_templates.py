...
MODE_GREETING: dict[str, str] = {
    "business": (
        "비즈니스 관련해서 고민이 있으시군요.\n"
        "구체적으로 어떤 비즈니스 이벤트를 앞두고 계신가요? "
        "오늘 회사에서 중요한 발표를 하시나요, 파트너사와 계약을 하시나요? "
        "구체적으로 알려주시면 반드시 성공할 수 있는 솔루션을 코칭해드릴게요."
    ),
    "love": (
        "애정/인간관계 관련해서 고민이 있으시군요.\n"
        "구체적으로 어떤 고민이신가요? "
        "오늘 데이트가 있으신가요? 직장 상사와의 관계 때문에 힘드신가요? "
        "구체적으로 알려주시면 반드시 성공할 수 있는 솔루션을 코칭해드릴게요."
    ),
    "wealth": (
        "재물 관련해서 고민이 있으시군요.\n"
        "구체적으로 어떤 고민중이신가요? "
        "오늘 부동산 계약을 앞두고 계신가요? 주식 매수를 할 계획이신가요?\n"
        "구체적으로 알려주시면 반드시 성공할 수 있는 솔루션을 코칭해드릴게요."
    ),
    "study": (
        "학업 관련해서 고민이 있으시군요.\n"
        "구체적으로 어떤 고민중이신가요? "
        "오늘 시험을 앞두고 있나요? 새로운 공부를 시작할 계획이신가요? "
        "구체적으로 알려주시면 반드시 성공할 수 있는 솔루션을 코칭해드릴게요."
    ),
    "health": (
        "건강 관련해서 고민이 있으시군요.\n"
        "구체적으로 어떤 고민이신가요? "
        "오늘 특히 불편한 부위가 있으신가요? 오늘 운동을 할까 말까 고민이신가요? "
        "구체적으로 알려주시면 반드시 성공할 수 있는 솔루션을 코칭해드릴게요."
    ),
}
